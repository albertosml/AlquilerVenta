...
public class ConsultarAlquileres extends javax.swing.JFrame {
     ...
     */
    public ConsultarAlquileres() throws ClassNotFoundException {
        initComponents();
        ...
        // Poner título
        this.setTitle("Consultar Alquileres - AlquilerVenta");
    ...
    private void initComponents() {
        ...
        check_piso.setText("Piso:");
        check_piso.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                check_pisoActionPerformed(evt);
            }
        });

        check_inquilino.setText("Inquilino:");
    ...
    private void check_pisoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_check_pisoActionPerformed
    ...
    private void btn_consultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_consultarActionPerformed
        ...
        if(!check_piso.isSelected() && !check_inquilino.isSelected() && !check_anio.isSelected()) JOptionPane.showMessageDialog(rootPane, "No se puede hacer esa consulta, compruebe los datos");
            ...
            if(a.size() == 1 && "error".equals(a.get(0).get(0))) JOptionPane.showMessageDialog(rootPane, "No está conectado a la base de datos");
                ...
                total.setText("Total Alquileres: " + String.format("%.2f", tot_t) + " €");
            }
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new ConsultarAlquileres().setVisible(true);
                } catch (ClassNotFoundException ex) {
                    Logger.getLogger(ConsultarAlquileres.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
