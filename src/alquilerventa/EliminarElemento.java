...
public class EliminarElemento extends javax.swing.JFrame {
     ...
     */
    public EliminarElemento() throws ClassNotFoundException {
        initComponents();
        ...
        // Poner título
        this.setTitle("Eliminar Elemento - AlquilerVenta");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EliminarElemento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new EliminarElemento().setVisible(true);
                } catch (ClassNotFoundException ex) {
                    Logger.getLogger(EliminarElemento.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
