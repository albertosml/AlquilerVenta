...
public class NuevoElemento extends javax.swing.JFrame {
    ...
    public NuevoElemento() {
        ...
        // Poner título
        this.setTitle("Añadir Elemento - AlquilerVenta");
    }
    ...
    private void initComponents() {
        ...
        tit_precio.setText("Precio por Kg o L o Garrafa (en euros):");
    ...
    private void btn_aniadirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_aniadirActionPerformed
        ...
        if(!name.isEmpty()) {
            ...
            if(prec.matches("[0-9]+[.][0-9]+") || prec.matches("[0-9]+")) {
                ...
                try {
                    if("error".equals(o.addElemento(name, prec))) JOptionPane.showMessageDialog(rootPane, "No está conectado a la base de datos");
                    else {
                        JOptionPane.showMessageDialog(rootPane, "Elemento insertado con éxito");
                    ...
                    Logger.getLogger(NuevoElemento.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
            else JOptionPane.showMessageDialog(rootPane, "No se ha introducido el precio del elemento que se debe "
                + "escribir de la siguiente manera: por ejemplo, 135 ó 135.46");
        }
        else JOptionPane.showMessageDialog(rootPane, "No se ha introducido el nombre del elemento");
