...
public class RegistrarCliente extends javax.swing.JFrame {
    ...
    public RegistrarCliente() {
        ...
        // Poner título
        this.setTitle("Registrar Cliente/Inquilino - AlquilerVenta");
    }
    ...
    private void btn_aniadirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_aniadirActionPerformed
        if(!nombre.getText().isEmpty()) {
            ...
            try {
                if("error".equals(o.addCliente(nombre.getText()))) JOptionPane.showMessageDialog(rootPane,"No está conectado a la base de datos");
                else {
                    JOptionPane.showMessageDialog(rootPane,"El cliente ha sido insertado con éxito");
        ...
        else JOptionPane.showMessageDialog(rootPane, "El nombre no se ha insertado");
