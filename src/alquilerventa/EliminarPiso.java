...
public class EliminarPiso extends javax.swing.JFrame {
     ...
     */
    public EliminarPiso() throws ClassNotFoundException {
        initComponents();
        ...
        // Poner título
        this.setTitle("Eliminar Piso - AlquilerVenta");
    ...
    private void btn_eliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_eliminarActionPerformed
        OperacionesBD o = new OperacionesBD();
        try {
            if("error".equals(o.deletePiso(((String) piso.getValue()).split(": ")[0]))) JOptionPane.showMessageDialog(rootPane,"No está conectado a la base de datos");
            else {
                JOptionPane.showMessageDialog(rootPane,"El piso se ha eliminado con éxito");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EliminarPiso.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new EliminarPiso().setVisible(true);
                } catch (ClassNotFoundException ex) {
                    Logger.getLogger(EliminarPiso.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
